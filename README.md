...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-asana-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-asana-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-asana
# for installing globally
pixi global install python-asana
```
...
It is possible to list all of the versions of `python-asana` available on your platform:
...
```
pixi search python-asana --channel conda-forge
```
